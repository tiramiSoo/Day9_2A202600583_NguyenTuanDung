...
QUESTION = (
    "If a company breaks a contract, avoids taxes, violates SEC compliance rules, "
    "and mishandles customer data, what are the legal, tax, and regulatory consequences?"
)
